...
.intro-exit-split-straight .panel-bottom { clip-path: inset(50% 0 0 0); animation: splitBottom 0.8s forwards; }

.intro-exit-split-zigzag .panel-top { clip-path: polygon(0 0, 100% 0, 100% 50%, 80% 45%, 60% 55%, 40% 45%, 20% 55%, 0 50%); animation: splitTop 0.8s forwards; }
.intro-exit-split-zigzag .panel-bottom { clip-path: polygon(0 50%, 20% 55%, 40% 45%, 60% 55%, 80% 45%, 100% 50%, 100% 100%, 0 100%); animation: splitBottom 0.8s forwards; }

.intro-exit-split-curvy .panel-top { clip-path: polygon(0 0, 100% 0, 100% 50%, 85% 40%, 70% 55%, 50% 45%, 30% 60%, 15% 45%, 0 55%); animation: splitTop 0.8s forwards; }
.intro-exit-split-curvy .panel-bottom { clip-path: polygon(0 55%, 15% 45%, 30% 60%, 50% 45%, 70% 55%, 85% 40%, 100% 50%, 100% 100%, 0 100%); animation: splitBottom 0.8s forwards; }

.intro-exit-split-wobble .panel-top { clip-path: inset(0 0 50% 0); animation: splitWobbleTop 1.2s forwards; }
.intro-exit-split-wobble .panel-bottom { clip-path: inset(50% 0 0 0); animation: splitWobbleBottom 1.2s forwards; }
...
@keyframes splitWobbleTop {
  0% { transform: translateY(0); }
  20% { transform: translateY(10px); }
  40% { transform: translateY(-5px); }
  100% { transform: translateY(-100%); }
}
@keyframes splitWobbleBottom {
  0% { transform: translateY(0); }
  20% { transform: translateY(-10px); }
  40% { transform: translateY(5px); }
  100% { transform: translateY(100%); }
